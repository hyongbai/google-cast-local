 ...
 */
public abstract class MediaCaster implements RemoteMediaPlayer.OnStatusUpdatedListener, RemoteMediaPlayer.OnMetadataUpdatedListener, ResultCallback {
    private final static String TAG = "MediaCaster";
